...
#line 116 "parser.cpp" /* yacc.c:355  */
...
static const yytype_uint8 yytranslate[] =
{
      ...
      40,    41,    43,    48,    42,    47,     2,    44,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,    51,     2,    52,    46,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
       0,    48,    48,    51,    52,    55,    56,    59,    60,    63,
      66,    67,    70,    71,    74,    75,    78,    81,    82,    83,
      86,    87,    88,    89,    92,    93,    96,    97,    98,    99,
...
static const char *const yytname[] =
{
  ...
  "TK_GREATER_THAN_EQUALS", "TK_LOGICAL_AND", "TL_LOGICAL_OR",
  "TK_DOUBLE_COLON", "TK_ADD_ASGN", "TK_SUB_ASGN", "TK_MULT_ASGN",
  "TK_DIV_ASGN", "TK_MOD_ASGN", "TK_POW_ASGN", "TK_PRINT", "TK_PRINTLN",
  "TK_BOOL", "TK_INT", "TK_IF", "TK_ELSE", "TK_ELSEIF", "TK_WHILE",
  "TK_FOR", "TK_FUNCTION", "TK_RETURN", "TK_ARRAY", "TK_END", "TK_ERROR",
  "'('", "')'", "','", "'*'", "'/'", "'%'", "'^'", "'-'", "'+'", "'~'",
  "'!'", "'['", "']'", "$accept", "start", "new_line", "opEols",
  "statementList", "statement", "print_statement", "print_argument",
  "argument_expression_list", "expression", "shift_exp", "term",
  "exponent", "unary_exp", "post_id", "factor", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     285,   286,   287,   288,   289,   290,   291,   292,   293,   294,
      40,    41,    44,    42,    47,    37,    94,    45,    43,   126,
      33,    91,    93
};
# endif
...
{
      28,   -32,    10,    30,   -11,   -32,   -32,    -1,     0,    33,
     -32,   -32,    -3,    -3,   -11,   -32,   -32,   -32,   -32,   -31,
     -32,     8,     8,     8,     8,     8,    13,   -32,     7,   -22,
      14,   -32,   -32,   -32,    20,   -32,     2,    59,    22,   -32,
     -32,   -32,   -32,   -32,     8,     8,     8,     8,     8,     8,
     -32,   -32,   -17,   -32,    12,   -32,   -22,   -22,    14,    14,
      14,   -32,   -32,     8,   -32,   -32
};
...
{
       6,     4,     0,     5,     0,     1,     3,     0,     0,     6,
       8,     9,     0,     0,     4,     2,    35,    36,    37,    38,
      12,     0,     0,     0,     0,     0,     0,    13,    16,    19,
      23,    25,    30,    31,     0,     7,     0,     0,     0,    26,
      27,    28,    29,    10,     0,     0,     0,     0,     0,     0,
      11,    33,     0,    15,     0,    39,    18,    17,    20,    21,
      22,    24,    32,     0,    34,    14
};
...
{
      16,    17,    18,    19,    20,    16,    17,    18,    19,    36,
       5,    16,    17,    18,    19,     7,     8,    38,    44,    45,
      37,    46,    47,    48,    62,    63,    39,    40,    41,    42,
      56,    57,    53,    58,    59,    60,     1,    21,     6,    12,
      13,    14,    21,    51,    22,    23,    24,    25,    21,    22,
      23,    24,    25,    61,    43,    22,    23,    24,    25,    65,
      49,    50,    54,    55,    64,    15,    35,    34
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     5,     6,     7,     3,     4,     5,     6,    40,
       0,     3,     4,     5,     6,    26,    27,    21,    11,    12,
      51,    43,    44,    45,    41,    42,    22,    23,    24,    25,
      44,    45,    36,    46,    47,    48,     8,    40,     8,    40,
      40,     8,    40,    41,    47,    48,    49,    50,    40,    47,
      48,    49,    50,    49,    41,    47,    48,    49,    50,    63,
      46,    41,     3,    41,    52,     9,    14,    13
};
...
{
       0,     8,    54,    55,    56,     0,     8,    26,    27,    57,
      58,    59,    40,    40,     8,    56,     3,     4,     5,     6,
       7,    40,    47,    48,    49,    50,    60,    62,    63,    64,
      65,    66,    67,    68,    60,    58,    40,    51,    62,    66,
      66,    66,    66,    41,    11,    12,    43,    44,    45,    46,
      41,    41,    61,    62,     3,    41,    64,    64,    65,    65,
      65,    66,    41,    42,    52,    62
};
...
#line 48 "parser.y" /* yacc.c:1646  */
    {(yyvsp[-1].blkstatement_t)->execute();}
...
#line 66 "parser.y" /* yacc.c:1646  */
    {(yyval.statement_t) = new PrintStatement((yyvsp[-1].expr_t),false);}
#line 1345 "parser.cpp" /* yacc.c:1646  */
    break;

  case 11:
#line 67 "parser.y" /* yacc.c:1646  */
    {(yyval.statement_t) = new PrintStatement((yyvsp[-1].expr_t),true);}
...
#line 96 "parser.y" /* yacc.c:1646  */
    {(yyval.expr_t) = new UnarySubExpr((yyvsp[0].expr_t));}
...
#line 106 "parser.y" /* yacc.c:1646  */
    {(yyval.expr_t) = new BracketPostIdExpr(string((yyvsp[-3].charPointer_t)),(yyvsp[-1].int_t)); delete (yyvsp[-3].charPointer_t);}
...
#line 110 "parser.y" /* yacc.c:1646  */
    {(yyval.expr_t) = new BoolExpr((yyvsp[0].bool_t));}
